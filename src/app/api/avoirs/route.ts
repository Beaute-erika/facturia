  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        numero:         body.numero?.trim() || await generateDocumentNumber(supabase, user.id, "avoirs"),
        ...
        date_emission:  body.date_emission ?? new Date().toISOString().split("T")[0],
